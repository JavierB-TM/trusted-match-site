...
const CONTENT: Record<string, { title: string; paragraphs: string[] }> = {
  ...
  technology: {
    title: "Technology",
    paragraphs: [
      "PSI is a cryptographic protocol allowing two parties to compute the intersection of their datasets...",
      "At TrustedMatch, we support both hashing-based PSI and advanced MPC-based PSI...",
      "We process pseudonymized data inside hardware-enforced enclaves to guarantee confidentiality.",
      "Providers include AWS Nitro Enclaves, Azure Confidential Computing, IBM Confidential Computing...",
      "Combine PSI and secure enclaves to maximize privacy...",
    ],
  },
};
...
const FeaturePage: FC<Props> = async ({ params }) => {
  ...
  if (!page) {
    return (
      <main className="pt-24 min-h-screen bg-white px-6 py-12 scroll-mt-16">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">Page not found</h1>
          <p className="text-gray-700 mb-6">The slug "{slug}" does not exist.</p>
