      ...
      <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="file1-clean" className="block text-sm font-medium text-gray-700 mb-2">
                First Dataset
              </label>
              <input
                id="file1-clean"
            ...
            <div>
              <label htmlFor="file2-clean" className="block text-sm font-medium text-gray-700 mb-2">
                Second Dataset
              </label>
              <input
                id="file2-clean"
